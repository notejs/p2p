...
var imagefiles = fs.readdirSync("images/tunning/");
var fileMap = {};
...
for (var n = 0; n < imagefiles.length; n++) {
    ...
    if (fileName.length === 8) {
        ...
        count1++;
        getPixels("images/tunning/" + fileName + ".jpg", function(fileName) {
            return function(err, pixels) {
                ...
                if (imgs.length != 4) {
                    ...
                    console.log("Succeed=======================", fileName, count0, count1, imagefiles.length)
                }
                for (var i = 0; i < imgs.length; i++) {
                    ...
                    savePixels(nda, "png").pipe(fs.createWriteStream("images/tunning/" + fileName + "_" + i + ".png"));
